...
export default function VRChatLogo(props: VRChatLogoProps) {
    return (
        <svg className={props.className} aria-labelledby="svg-inline--fa-title-vrchat" data-prefix="fab" data-icon="vrchat" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="3 5 34 35">
